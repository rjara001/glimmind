    ...
    <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4 overflow-hidden">
      ...
      <div className="flex gap-3 overflow-x-auto pb-2 md:overflow-visible md:pb-0 md:w-auto">
        <button
          ...
          className="text-indigo-700 bg-indigo-50 border border-indigo-200 px-4 py-2.5 rounded-lg font-semibold hover:bg-indigo-100 transition shadow-sm flex items-center gap-2 flex-shrink-0 justify-center"
        >
